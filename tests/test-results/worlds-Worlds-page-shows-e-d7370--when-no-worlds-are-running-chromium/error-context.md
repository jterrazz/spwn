...
- Name: worlds.spec.ts >> Worlds page >> shows example gallery when no worlds are running
- Location: ui/specs/worlds.spec.ts:21:3
...
Locator: getByText('Pick a template')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Pick a template')
      ...
      - main [ref=e6]:
        - generic [ref=e9]:
          ...
          - button "Retry now" [ref=e27] [cursor=pointer]:
            - img [ref=e28]
            - text: Retry now
          - generic [ref=e31]: Checking every 3s · last check 1s ago
