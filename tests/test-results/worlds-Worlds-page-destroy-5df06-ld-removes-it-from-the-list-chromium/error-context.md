...
- Name: worlds.spec.ts >> Worlds page >> destroying a world removes it from the list
- Location: ui/specs/worlds.spec.ts:60:3
...
Locator: getByText(/Pick a template|Give your agents/)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/Pick a template|Give your agents/)
