...
- Name: worlds.spec.ts >> Worlds page >> shows the Worlds heading
- Location: ui/specs/worlds.spec.ts:9:3
...
Locator: getByRole('heading', { name: 'Worlds' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Worlds' })
