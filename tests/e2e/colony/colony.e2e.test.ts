...
import { expectLine, expectNoLine, stripAnsi } from '../../setup/output-helpers.js';
import {
    createTestContext,
    parseWorldId,
    type TestContext,
...
describe('colony E2E', () => {
    ...
    test('worker inbox shows message from chief', () => {
        ...
        ctx.spwn(['agent', 'send', 'neo', '--from', 'morpheus', 'implement auth module']);
    ...
    test('message file directory exists in container after first send', () => {
        ...
        ctx.spwn(['agent', 'send', 'neo', '--from', 'morpheus', 'check inbox persistence']);
