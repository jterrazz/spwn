...
describe('marketplace - spwn get', () => {
    ...
    test("'spwn get install nonexistent' handles gracefully", async () => {
        const result = await spwn('get install nonexistent').exec('get install nonexistent').run();
    ...
    test("'spwn get rm nonexistent' handles gracefully", async () => {
        const result = await spwn('get rm nonexistent').exec('get rm nonexistent').run();
    ...
    test("'spwn get search' handles search query", async () => {
        const result = await spwn('get search test').exec('get search test').run();
