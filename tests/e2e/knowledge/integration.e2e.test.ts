...
describe('knowledge integration', () => {
    ...
    test('world knowledge dir is created inside the container on demand', () => {
        ...
        universe.exec("mkdir -p /world/knowledge && echo '# Test' > /world/knowledge/note.md");
    ...
    test('knowledge update via API persists to disk', () => {
        ...
        const readBack = readFileSync(testFilePath, 'utf8');
        ...
        const readUpdated = readFileSync(testFilePath, 'utf8');
