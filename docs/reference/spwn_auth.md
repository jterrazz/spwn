...
Manage credentials — dashboard, login, use, logout, disable
...
* [spwn auth default](./spwn_auth_default.md)	 - Pick which provider spwn prefers when multiple are authenticated
