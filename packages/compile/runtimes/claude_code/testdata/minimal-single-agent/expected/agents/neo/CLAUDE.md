...
4. **Messaging**: to send a message to another agent, write a .json or .md file to `/world/inbox/<their-name>/`. To check YOUR inbox, read `/world/inbox/neo/`. Read `/world/skills/collaboration.md` for the full messaging protocol.
