// Package ports defines the canonical interfaces (ports) for the world domain.
...
// in packages/world/internal/backend should be kept in sync with this interface.
...
// WorldRecord is the persistence representation of a world instance.
