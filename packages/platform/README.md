...
- `MindLayers` — canonical ordered list of the three mind-layer directories (skills, playbooks, journal). Identity was collapsed into a single SOUL.md at the agent root; knowledge is world-scoped, not agent-scoped.
