    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            <div className="text-center">
                <h1 className="text-6xl font-heading tracking-wide text-foreground/20 mb-4">404</h1>
                <p className="text-lg text-muted-foreground/40 font-heading mb-2">Page not found</p>
