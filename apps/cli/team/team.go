...
var newCmd = &cobra.Command{
  ...
  spwn team new infra --color purple`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := project.CreateTeam(t); err != nil {
...
var lsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		for _, t := range teams {
			members, _ := project.TeamMembers(t.Slug)
...
var editCmd = &cobra.Command{
  ...
  spwn team edit infra --description "Infrastructure & ops"`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := project.UpdateTeam(*t); err != nil {
			return err
		}
		s.Blank()
...
var assignCmd = &cobra.Command{
  ...
  spwn team assign qa --clear`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := project.SetAgentTeam(agentName, teamSlug); err != nil {
...
var membersCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		slug := args[0]
		members, err := project.TeamMembers(slug)
		if err != nil {
			return err
		}
		if len(members) == 0 {
