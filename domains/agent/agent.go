...
import (
	...
	"github.com/jterrazz/spwn/domains/agent/internal/journal"
	"github.com/jterrazz/spwn/domains/agent/internal/mind"
	"github.com/jterrazz/spwn/domains/agent/internal/session"
)
...
func InspectAgent(name string) (*AgentInfo, error) {
