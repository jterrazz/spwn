...
func (s *Store) List() ([]models.Universe, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	return s.load()
}
...
func (s *Store) Get(id string) (*models.Universe, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *Store) Save(u models.Universe) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *Store) Delete(id string) error {
	...
	filtered := make([]models.Universe, 0, len(universes))
...
func (s *Store) UpdateStatus(id string, status models.UniverseStatus) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *Store) load() ([]models.Universe, error) {
...
func (s *Store) save(universes []models.Universe) error {
