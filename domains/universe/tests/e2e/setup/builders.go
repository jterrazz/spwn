...
func (b *SpawnBuilder) WithGate(bridges ...gate.GateBridge) *SpawnBuilder {
...
func (b *SpawnBuilder) buildManifest() universe.UniverseManifest {
	b.tc.T.Helper()
...
func (b *SpawnBuilder) parseInlineYAML() universe.UniverseManifest {
	b.tc.T.Helper()
